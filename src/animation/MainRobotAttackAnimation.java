 ...
 * @author Utente
 */
public class MainRobotAttackAnimation extends AbstractAnimation{
    ...
    public MainRobotAttackAnimation(AnimationPanel animPanel){
        super(null,null, animPanel);
        mRSprites = new MainRobotSprites();
        this.animFrameArray = mRSprites.getMainRobotAttackSprites();
        //this.animShiftMatrix = mRSprites.getMainRobotAttackShiftArray();
    };
