 ...
 * @author Utente
 */
public class PirateZombieAnimation extends AbstractAnimation{
...
private static int DEATH_ANIMATION_DELAY = 825;
    ...
    private Thread zombieThread;
        ...
        public PirateZombieAnimation(AnimationPanel animPanel){
            super(null,null,animPanel);
            zombieSp = new ZombieSprite();
            this.enemyFrameArray1 = zombieSp.getPirateZombieSprite();
            ...
            this.currentEnemy1FrameIndex =2;
        }// end constructor
    ...
    public void showCurrentFrame(Graphics g, int x, int y){
        ...
        Image frameImg = this.enemyFrameArray1[this.currentEnemy1FrameIndex];
        ...
        if(gameTime>0){
            if(isDead == false){            
               ...
               if(this.getCurrentX() > mrA.getMaxX()+125 && this.zombieHurtTimer.isRunning()==false || (this.getCurrentX()< mrA.getCurrentX()-150  && this.zombieDeathTimer.isRunning()==false) ){
                   yShift=0;
                   this.currentEnemy1FrameIndex++;
                    this.currentEnemy1FrameIndex%=3;
                ...
                if(this.getCurrentX() <= mrA.getMaxX()+125 && this.getCurrentX() > mrA.getCurrentX() && this.zombieHurtTimer.isRunning()==false){
                    ...
                    this.currentEnemy1FrameIndex%=2;
                    this.currentEnemy1FrameIndex +=3;
                    if(count%7 == 6 && this.currentEnemy1FrameIndex==4){
                        mrA.numberOfDot--;
                    }
                    if(this.currentEnemy1FrameIndex==4){
                        count++;
                    }
                    if(mrA.numberOfDot<1 && this.currentEnemy1FrameIndex==4){
                        this.zombieAttackTimer.stop();
                    }
                }
                ...
                if(hit==1 && isStrike == false || this.zombieHurtTimer.isRunning()){
                    ...
                    this.currentEnemy1FrameIndex%=2;
                    this.currentEnemy1FrameIndex += 5;
                    if(this.currentEnemy1FrameIndex==6){
                        this.zombieHurtTimer.stop();
                        isStrike=true;
                ...
                if(hit>1){
                    ...
                    this.zombieAttackTimer.stop();
                    this.currentEnemy1FrameIndex %=3;
                    this.currentEnemy1FrameIndex += 7;
                    if(this.currentEnemy1FrameIndex==8){
                        yShift=160;
                    }
                    if(this.currentEnemy1FrameIndex==9){
                ...
                //System.out.print(mrA.getMaxX()+"\n");
                //System.out.print(this.getCurrentX()+"\n");
                //System.out.print(counterZombieDeath+"\n");
        } // end gameTime  
    ...
    public int getAnimationWidth(){
        return this.enemyFrameArray1[this.currentEnemy1FrameIndex].getWidth(null);
    };
    
    @Override
    public int getAnimationHeight(){
        return this.enemyFrameArray1[this.currentEnemy1FrameIndex].getHeight(null);
    };
